...
export default function CmsLayout({ children }: CmsLayoutProps) {
  ...
  const navigation = [
    { name: '대시보드', href: '/cms/dashboard', icon: HomeIcon },
    { name: '히어로 슬라이드 관리', href: '/cms/hero-slides', icon: PresentationChartLineIcon },
    { name: '메뉴/페이지 관리', href: '/cms/menus', icon: Bars3BottomLeftIcon },
    { name: '게시판 관리', href: '/cms/boards', icon: TableCellsIcon },
    { name: '게시글 관리', href: '/cms/posts', icon: DocumentTextIcon },
    { name: '파일 관리', href: '/cms/files', icon: PhotoIcon },
    { name: '카테고리 관리', href: '/cms/categories', icon: TagIcon },
    { name: '에너지 데이터 관리', href: '/cms/energy-data', icon: BoltIcon },
    { name: '태양광 발전 관리', href: '/cms/solar-data', icon: SunIcon },
  ];
